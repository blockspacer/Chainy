...
bool
chainy::consumer_t::DoInternalWork()
{
...
// MessagePump methods: 
void    
chainy::consumer_t::ScheduleWork()
{       
	char buf = 0;
...
void    
chainy::consumer_t::ScheduleDelayedWork (
...
void
chainy::consumer_t::OnCanReadWithoutBlocking (
	RsslChannel* c
	)
{
...
void
chainy::consumer_t::OnInitializingState (
	RsslChannel* c
	)
{
...
void
chainy::consumer_t::OnCanWriteWithoutBlocking (
	RsslChannel* c
	)
{
...
void
chainy::consumer_t::OnActiveWriteState (
	RsslChannel* c
	)
{
	RsslError rssl_err;
 ...
 */
bool
chainy::consumer_t::OnActiveSession (
	RsslChannel* c
	)
{
...
bool
chainy::consumer_t::SendLoginRequest (
	RsslChannel* c
	)
{
...
bool
chainy::consumer_t::SendDirectoryRequest (
	RsslChannel* c
	)
{
#ifndef NDEBUG
...
bool
chainy::consumer_t::SendDictionaryRequest (
	RsslChannel* c,
...
bool
chainy::consumer_t::SendItemRequest (
	RsslChannel* c,
 ...
 */
bool
chainy::consumer_t::CreateItemStream (
...
void
chainy::consumer_t::CreateInfo (
	chainy::ConsumerInfo* info
	)
{
...
void
chainy::consumer_t::OnActiveReadState (
	RsslChannel* c
	)
{
	RsslBuffer* buf;
...
bool
chainy::consumer_t::OnLoginResponse (
	RsslChannel* c,
	RsslDecodeIterator* it,
	RsslMsg* msg
	)
 ...
 */
bool
chainy::consumer_t::OnDirectoryRefresh (
	RsslChannel* c,
...
bool
chainy::consumer_t::OnDirectoryUpdate (
	RsslChannel* c,
...
bool
chainy::consumer_t::OnDictionary (
	RsslChannel* c,
	RsslDecodeIterator* it,
	RsslMsg* msg
	)
...
bool
chainy::consumer_t::OnDictionaryRefresh (
	RsslChannel* c,
	RsslDecodeIterator* it,
...
bool
chainy::consumer_t::OnLoginSuccess (
	RsslChannel* c,
...
bool
chainy::consumer_t::OnLoginSuspect (
	RsslChannel* c,
	const RsslRDMLoginMsg& response
	)
{
...
bool
chainy::consumer_t::OnLoginClosed (
	RsslChannel* c,
	const RsslRDMLoginMsg& response
	)
{
...
bool
chainy::consumer_t::OnMarketPrice (
	RsslChannel* handle,
	RsslDecodeIterator* it,
	RsslMsg* msg
	)
...
bool
chainy::consumer_t::OnMarketPriceRefresh (
	RsslChannel* handle,
	RsslDecodeIterator* it,
	RsslMsg* msg,
...
bool
chainy::consumer_t::OnMarketPriceUpdate (
	RsslChannel* handle,
	RsslDecodeIterator* it,
	RsslMsg* msg,
	std::shared_ptr<item_stream_t> stream
