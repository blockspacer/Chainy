...
/* marker */
	...
	class provider_t
		...
		, public ChainyHttpServer::ProviderDelegate
	{
	public:
		...
		bool Initialize (chromium::MessageLoop* consumer, ChainyHttpServer::ConsumerDelegate* consumer_delegate);
		void Close();
...
/* Built in HTTP server. */
		std::shared_ptr<ChainyHttpServer> server_;
