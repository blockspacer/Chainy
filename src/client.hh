...
#ifdef CHAINYMIB_H
		friend Netsnmp_Next_Data_Point chainyClientTable_get_next_data_point;
		friend Netsnmp_Node_Handler chainyClientTable_handler;

		friend Netsnmp_Next_Data_Point chainyClientPerformanceTable_get_next_data_point;
		friend Netsnmp_Node_Handler chainyClientPerformanceTable_handler;
#endif /* CHAINYMIB_H */
