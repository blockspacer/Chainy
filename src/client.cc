...
chainy::client_t::client_t (
	std::shared_ptr<chainy::provider_t> provider,
	Delegate* delegate, 
	RsslChannel* handle,
	const char* address
	) :
 ...
 */
bool
chainy::client_t::OnLoginRequest (
	RsslDecodeIterator* it,
...
bool
chainy::client_t::OnLoginAttribInfo (
 ...
 */
bool
chainy::client_t::OnDirectoryRequest (
	RsslDecodeIterator* it,
	const RsslRequestMsg* request_msg
	)
{
...
bool
chainy::client_t::OnDictionaryRequest (
	RsslDecodeIterator* it,
	const RsslRequestMsg* request_msg
	)
{
...
/* Filtered before entry. */
	CHECK(RSSL_DMT_SYMBOL_LIST == model_type);
...
bool
chainy::client_t::OnSourceDirectoryUpdate()
{
 ...
 */
bool
chainy::client_t::SendDirectoryRefresh (
	int32_t request_token,
...
bool
chainy::client_t::SendDirectoryUpdate (
