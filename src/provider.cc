...
chainy::provider_t::provider_t (
	const chainy::config_t& config,
	std::shared_ptr<chainy::upa_t> upa,
	chainy::client_t::Delegate* request_delegate 
	) :
 ...
 */
bool
chainy::provider_t::Initialize (
	chromium::MessageLoop* consumer,
	chainy::ChainyHttpServer::ConsumerDelegate* consumer_delegate
	)
{
#ifndef NDEBUG
...
/* Built in HTTPD server. */
	server_.reset (new ChainyHttpServer (this, consumer, consumer_delegate, this));
...
bool
chainy::provider_t::WriteRawClose (
...
void
chainy::provider_t::CreateInfo (
	chainy::ProviderInfo* info
	)
{
...
bool
chainy::provider_t::DoInternalWork()
{
	bool did_work = false;
...
bool
chainy::provider_t::WatchFileDescriptor (
	net::SocketDescriptor fd,
	bool persistent,
	chainy::provider_t::Mode mode,
	chainy::provider_t::FileDescriptorWatcher* controller,
	chainy::provider_t::Watcher* delegate
	)
{
	DCHECK_GE(fd, 0);
	DCHECK(controller);
...
chainy::provider_t::FileDescriptorWatcher::FileDescriptorWatcher()
	: event_ (nullptr)
	, pump_ (nullptr)
	, watcher_ (nullptr)
...
bool
chainy::provider_t::FileDescriptorWatcher::StopWatchingFileDescriptor()
{
...
void
chainy::provider_t::FileDescriptorWatcher::Init (chainy::provider_t::FileDescriptorWatcher::event *e)
{
	DCHECK(e);
	DCHECK(!event_);
...
chainy::provider_t::FileDescriptorWatcher::event*
chainy::provider_t::FileDescriptorWatcher::ReleaseEvent()
{
...
void
chainy::provider_t::FileDescriptorWatcher::OnFileCanReadWithoutBlocking (
	net::SocketDescriptor fd,
	chainy::provider_t* pump
	)
{
	if (!watcher_)
		return;
...
void
chainy::provider_t::FileDescriptorWatcher::OnFileCanWriteWithoutBlocking (
	net::SocketDescriptor fd,
	chainy::provider_t* pump
	)
{
...
// MessagePump methods:
void
chainy::provider_t::ScheduleWork()
{
	char buf = 0;
...
void
chainy::provider_t::ScheduleDelayedWork (
 ...
 */
void
chainy::provider_t::OnConnection (
...
void
chainy::provider_t::RejectConnection (
	RsslServer* rssl_sock
	)
{
#ifndef NDEBUG
...
void
chainy::provider_t::AcceptConnection (
	RsslServer* rssl_sock
	)
{
#ifndef NDEBUG
...
void
chainy::provider_t::OnCanReadWithoutBlocking (
	RsslChannel* c
	)
{
	DCHECK (nullptr != c);
...
void
chainy::provider_t::OnInitializingState (
	RsslChannel* c
	)
{
...
void
chainy::provider_t::OnCanWriteWithoutBlocking (
	RsslChannel* c
	)
{
	RsslError rssl_err;
 ...
 */
void
chainy::provider_t::OnActiveClientSession (
	RsslChannel* c
	)
{
	DCHECK (nullptr != c);
...
void
chainy::provider_t::OnActiveState (
	RsslChannel* c
	)
{
	RsslBuffer* buf;
...
void
chainy::provider_t::RejectClientSession (
	RsslChannel* handle,
	const char* address
	)
{
...
bool
chainy::provider_t::AcceptClientSession (
	RsslChannel* handle,
	const char* address
	)
{
 ...
 */
bool
chainy::provider_t::GetDirectoryMap (
 ...
 */
bool
chainy::provider_t::GetServiceDirectory (
	RsslEncodeIterator*const it,
	const char* service_name,	/* nullptr for all services */
	uint32_t filter_mask
	)
...
bool
chainy::provider_t::GetServiceFilterList (
	RsslEncodeIterator*const it,
	uint32_t filter_mask
	)
{
 ...
 */
bool
chainy::provider_t::GetServiceInformation (
	RsslEncodeIterator*const it
	)
{
#ifndef NDEBUG
 ...
 */
bool
chainy::provider_t::GetServiceCapabilities (
	RsslEncodeIterator*const it
	)
{
#ifndef NDEBUG
...
/* 1: SymbolList = 10 */
	static const uint64_t rdm_domain = RSSL_DMT_SYMBOL_LIST;
...
bool
chainy::provider_t::GetServiceDictionaries (
	RsslEncodeIterator*const it
	)
{
#ifndef NDEBUG
...
bool
chainy::provider_t::GetServiceQoS (
	RsslEncodeIterator*const it
	)
{
#ifndef NDEBUG
 ...
 */
bool
chainy::provider_t::GetServiceState (
	RsslEncodeIterator*const it
	)
{
#ifndef NDEBUG
 ...
 */
bool
chainy::provider_t::GetServiceLoad (
	RsslEncodeIterator*const it
	)
{
#ifndef NDEBUG
