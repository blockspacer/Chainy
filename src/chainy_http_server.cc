...
chainy::ConsumerInfo::ConsumerInfo()
	: is_active (false)
	, msgs_received (0) {
}
...
chainy::ProviderInfo::ProviderInfo()
	: pid (0)
	, client_count (0)
	, msgs_received (0) {
}
...
chainy::ChainyHttpServer::ChainyHttpServer (
	...
	chainy::ChainyHttpServer::ProviderDelegate* provider_delegate
	)
	: port_ (0)
...
void
chainy::ChainyHttpServer::Shutdown()
{
	if (!(bool)server_)
		return;
...
void
chainy::ChainyHttpServer::OnHttpRequest (
	int connection_id,
...
void
chainy::ChainyHttpServer::OnWebSocketRequest (
	int connection_id,
	const net::HttpServerRequestInfo& info
	)
{
...
void
chainy::ChainyHttpServer::OnWebSocketMessage (
	int connection_id,
...
void
chainy::ChainyHttpServer::OnClose (
	int connection_id
	)
{
}
...
void
chainy::ChainyHttpServer::OnJsonRequestUI (
	int connection_id,
	const net::HttpServerRequestInfo& info
	)
{
...
void
chainy::ChainyHttpServer::OnDiscoveryPageRequestUI (
	int connection_id
	)
{
...
void
chainy::ChainyHttpServer::OnPollScriptRequestUI (
	int connection_id
	)
{
...
void
chainy::ChainyHttpServer::SendJson (
	int connection_id,
...
std::string
chainy::ChainyHttpServer::GetDiscoveryPageHTML() const
{
	ProviderInfo info;
	provider_delegate_->CreateInfo (&info);
...
std::string
chainy::ChainyHttpServer::GetPollScriptJS() const
{
